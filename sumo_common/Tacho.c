...
#define PULSE_PER_WING      4   /* Number of pulses that one wing on the encoder generates */
#define NOF_WINGS           3   /* Number of wings on the encoder wheel */
#define GEAR_RATIO          75  /* Gear ratio between motor and wheel */
#define PERIMETER_WHEEL     12  /* Perimeter of the wheel with crawler (D * pi) */
